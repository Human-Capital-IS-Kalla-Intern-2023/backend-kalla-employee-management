...
class SalaryDetailController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $components = SalaryDetail::query()->when($search, function($query) use($search) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $salarycomponent = SalaryDetail::create([
    ...
    {
        try {
            $component = SalaryDetail::findOrFail($id);
    ...
    public function update(Request $request, String $id)
    {
        $validation = $this->validate($request, [
            'salary_id' => ['required', 'string'],
            'order' => ['required', 'string'],
            'component_name' => ['required','unique:salary_components,component_name,'.$id.',id,deleted_at,NULL','string'],
            'type' => ['required','in:fixed pay,deductions'],
            'is_hide' => ['required','boolean'],
            'is_edit' => ['required','boolean'],
            'is_active' => ['required','boolean'],
